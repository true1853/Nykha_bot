...
from astral.geocoder import Geocoder as AstralGeocoder # Импортируем класс Geocoder
...
from aiogram.types import (
    ...
    ReplyKeyboardMarkup, KeyboardButton, ContentType # Добавляем ContentType
)
...
try:
    astral_geo = AstralGeocoder() # Создаем экземпляр Astral Geocoder
