...
def log_memory_usage(operation: str) -> None:
    ...
    logger.debug(f"{operation} memory usage: {memory['rss']:.1f}MB RSS, {memory['percent']:.1f}%")
...
class QueryOptimizer:
    ...
    @staticmethod
    def batch_insert(table: str, data: list, batch_size: int = 100) -> str:
