...
from data import (
    CATEGORY_EMOJI_MAP
)  # DEFAULT_PHASE removed

# from handlers.checkpoints import CHECKPOINT_MANTRAS  # removed to avoid circular import
# define or import mantras list from a non-handler module
CHECKPOINT_MANTRAS = [
